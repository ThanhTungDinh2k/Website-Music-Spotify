...
export const getAllFile = async ( //admin
  req: Request<{ fileId: string }, string, { id: string; fileId: string }>,
  res: Response
): Promise<Response<any>> => {
  try {
...
export const getAllFilePublic = async ( //user
  req: Request<{ fileId: string }, string, { id: string; fileId: string }>,
  res: Response
): Promise<Response<any>> => {
  try {
...
export const uploadFileServer = async ( //uer upload len DB
...
export const getAllFilePublicServer = async ( //lay driver
  req: Request<
    unknown,
    unknown,
    unknown,
...
export const updateFile = async ( // chinh
